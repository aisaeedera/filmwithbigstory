...
const positions = [
  ...
  { title: "Wedding Videographer", ar: "مصور فيديو أعراس", tier: "T1", type: "Emirati weddings", summary: "Experienced wedding operators who understand privacy, pace and women-only celebrations.", summaryAr: "مصورون ذوو خبرة يفهمون الخصوصية وسرعة العمل وطبيعة حفلات الزفاف النسائية." },
